...
- **Interpretation and implication** — reading a situation for what it *means*, connecting scattered facts into intent (a raw WIS check where no skill fits).
...
| Score | Mod | What this WIS looks like |
|---|---|---|
| 1 | −5 | Grasps nothing beyond the literal; no read of people or aura at all. |
| 2 | −4 | Profoundly naive; misreads every situation. |
| 3 | −4 | Still profoundly naive, but learns the same lesson if it repeats often enough. |
| 4 | −3 | Very poor judgment; easily fooled. |
| 5 | −3 | A little sharper, but still blind to implication. |
| 6 | −2 | Slow to catch on; misses subtext. |
| 7 | −2 | A touch quicker, but still misses most warning signs. |
| 8 | −1 | A bit oblivious to undercurrents. |
| 9 | −1 | Mildly oblivious; catches the obvious undercurrents only. |
| 10 | +0 | Average adult — reads a room passably. |
...
*Foresight-flavored clans (e.g., [[Ubuyashiki]]) express their gift as unnaturally high effective WIS for reading people and danger — trait-granted, not the ordinary scale.*
