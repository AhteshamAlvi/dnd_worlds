...
**Enhancement** is the ability to use aura to strengthen or increase the natural abilities of an object or one's own body. Enhancers are able to increase their physical attack and defense greatly and are best suited for melee combat. They have much better efficiency and returns when using abilities like *[[Chū]]*. In fact, one's affinity for this category plays a crucial role in combat at all times, even when a Nen ability is not being used.
