 ...
 *
 *   age   height      mass     size    BMI    STR
 *     0    49.5 cm    1.76 kg   2.3 L   7.2     -
 *     2    85.8 cm    8.86 kg  10.7 L  12.0     -
 *     6   115.5 cm   20.13 kg  23.1 L  15.1     -
 *    12   146.9 cm   43.01 kg  46.2 L  19.9     -
 *    16   160.1 cm   56.37 kg  56.2 L  22.0     -
 *    20   165.0 cm   62.00 kg  60.0 L  22.8     -
 *    40   165.0 cm   62.68 kg  61.2 L  23.0     -
 *    60   163.4 cm   59.36 kg  60.7 L  22.2     -
 *    80   160.1 cm   51.61 kg  55.7 L  20.1     -
 *
 * Height, mass and size are generated by measurements/resolution.ts from this
 * curve and the Basic Human Standard, not authored here and not hand-computed.
 * The twenty-year-old row is the reference body itself, which is what makes
 * this table a check on the curve rather than a restatement of it.
 *
 * The STR column is deliberately empty. Strength resolves from Structural
 * Capacity through the Muscularity force factor, which does not exist yet;
 * this table is closed once the Strength subsystem lands. Nothing in it will
 * be authored when it is. STR falls out of Scale squared and the muscularity
 * curve, which is the point: a six-year-old is weaker than an adult because
