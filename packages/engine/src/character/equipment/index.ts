...
import {
  ITEM_BOUNDARY_MODES,
  ITEM_CONDUCTIVITY_AUTHORITIES,
  ITEM_CONDUCTIVITY_BANDS,
  ITEM_CONDUCTIVITY_CEILING,
  ITEM_CONDUCTIVITY_FLOOR,
  ITEM_GEOMETRY_SHAPES,
  ITEM_MEASURE_KINDS_BY_MODE,
  ITEM_ORDINARY_CONDUCTIVITY_MAXIMUM,
  ITEM_SURFACE_MEASURE_KINDS,
  ...
  type ItemBoundaryMode,
  type ItemBoundaryPhysics,
  type ItemConductivityAuthority,
  type ItemConductivityAuthorization,
  type ItemConductivityBand,
  type ItemGeometry,
  type ItemGeometryShape,
  type ItemSurfaceMeasure,
  type ItemSurfaceMeasureKind,
} from "./physics";

import {
  ITEM_SCALABLE_EFFECT_TYPES,
  enhanceItemEnvelope,
  itemIntegrityMitigationFor,
  scaleItemEffect,
  type ItemEnhancement,
  type ItemScalableEffectType,
} from "./enhancement";
...
export type {
  ...
  ItemBoundaryMode,
  ItemBoundaryPhysics,
  ItemConductivityAuthority,
  ItemConductivityAuthorization,
  ItemConductivityBand,
  ...
  ItemScalableEffectType,
  ItemSurfaceMeasure,
  ItemSurfaceMeasureKind,
  ItemUse,
  ItemUseApplication,
  ItemUseInput,
  ItemUseResolution,
