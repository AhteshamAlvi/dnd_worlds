...
/*
 * Threat awareness — what ECP-1's prepared danger is consumed BY.
 *
 * Composition projects danger; SEN-1 decides who receives and detects it; this
 * layer holds the state between them and the Reaction Gate: which threat, which
 * subject, which phases have been tried, which ally noticed first, and what a
 * shouted warning is actually worth.
 */
export type {
  ActionEffectPoint,
  AlliedObserverCandidate,
  AlliedObserverInput,
  AlliedObserverSelection,
  AuthorizedGateResponse,
  AwarenessGateDisposition,
  AwarenessOrigin,
  AwarenessRouteRecord,
  CoarseDirection,
  CommunicationMethodRef,
  DangerDisclosure,
  DetectionAttemptRecord,
  EffectTimeliness,
  EndangeredSubject,
  EndangeredSubjects,
  EndangeredSubjectsInput,
  EndangermentSource,
  GateRevalidation,
  GateRevalidationInput,
  GateValidity,
  ObserverRefusal,
  ParticipantRelationship,
  ParticipantRelationshipFact,
  PendingThreatGate,
  PreparedWarning,
  RelationshipFactSet,
  RelationshipQuerySpec,
  SubjectAwareness,
  ThreatAwareness,
  ThreatGateBinding,
  ThreatGateKind,
  ...
  ThreatReceptionInput,
  ThreatSubject,
  ThreatTiming,
  WarningDeclarationInput,
  WarningEmission,
  WarningEmissionInput,
  WarningRecipientFailure,
  WarningRecipientInput,
...
export {
  ...
  contextDerivedApplicationValue,
  fixedApplicationValue,
  isContextDerived,
