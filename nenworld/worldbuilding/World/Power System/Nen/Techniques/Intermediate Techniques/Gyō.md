...
An alternative version of this technique gathers only the aura naturally leaking from the body instead of the greater amount produced by *[[Ren]]*. This application of *Gyō* can still increase the amount of aura in one selected body part and thus its power, but the output is much lower than what is obtained through the regular technique. This lower-consumption *Gyō* can not counter most variations of In, even if it suffices to see thin layers of aura.
