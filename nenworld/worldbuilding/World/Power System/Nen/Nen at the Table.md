...
## Conditions, Vows & Risk are the power economy

This is the main way anyone punches above their tier, and the system's central trade:

- **[[Conditions]]** shape and pay for an effect by equivalent exchange — the honest price that makes something possible at all.
- **[[Vows and Limitations]]** are self-imposed rules that *boost* power; stricter rule → bigger boost. They can be broken, and then the boost (or the ability) is gone.
- **[[Risk]]** adds real self-endangerment for real extra power.
...
- **You can't copy your way to mastery.** Borrowed abilities work but cap out; a practitioner only reaches their ceiling on abilities reasoned out themselves ([[Nen Ability]]).
- **Emotion and risk amplify.** High stakes and genuine feeling make Nen burn hotter — reward players who put something real on the line.
- **The user's own sense of fairness binds them.** Nobody can cheese their own conditions; if it feels like cheating to the character, their Nen treats it as cheating ([[Conditions]]).
