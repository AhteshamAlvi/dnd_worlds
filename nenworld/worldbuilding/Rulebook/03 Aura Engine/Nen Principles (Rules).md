...
The fifteen principles from the lore ([[0 Four Major Principles|Four Major Principles]], [[0 Intermediate Principles|Intermediate Principles]], [[0 Advanced Principles|Advanced Principles]]), statted. **Each owns a distinct mechanical job** — the design refuses to let any two be the same lever. Some are sustained states (Ten, Zetsu, Ken), some are concentration math (Gyō, Kō, Ryū — all resolved by the surface-area engine in [[Aura Density and Concentration]]), some are contests (In), some are resource decisions (En, Jū, Yū). The allocation framework they plug into is defined in [[Combat Core]]; the short version:

> Each round, a Nen user projects up to their **AO** ([[Aura Statistics]]) and decides two things: **how much** goes to Strike (offense), Guard (defense), Drive (speed), Focus (senses), and Fuel (abilities) — and **where on the body** it sits ([[Aura Density and Concentration|density]]). Principles change how well those convert, how concentrated they get, and what else you can do with them.
...
**Mastery.** Every principle has its own mastery rank, **I through X** (Learned → Mastered), tracked separately — there is no single Nen level. Growth Point costs, stat thresholds, Catalysts, Breakthroughs, foundation caps, and training times are all in [[Nen Growth]]. A principle used under its listed minimum rank for a stunt simply isn't available. Failure consequences are listed per principle; **Strain** is defined in [[Injury Recovery and Conditions]].

**Reading the rank entries.** Each principle below lists its effects at the **even** ranks — II, IV, VI, VIII, X. Odd ranks are consolidation: they cost their Growth Points, satisfy prerequisites and [[Nen Growth|foundation caps]], and count toward the next listed step, but the mechanical jump lands on the even rank. *(Design note: these five steps are the original, playtested five-tier ladder mapped onto the ten-rank scale, so every calibrated number — Ten's containment, En's radii, Ken's 10× — survives the rescale unchanged. [[Ren]] is the exception and is now continuous: see its entry.)*

**Concentration under fire.** Maintaining any sustained principle while taking Body damage requires a **CON (Endurance)** check, DC 10 + (damage taken ÷ 10, max +10) — holding aura together while hurt is stamina, not a lost "willpower" stat. Fail: the state drops at the end of the current action. [[Ten]] VI+ holds itself.
...
**STR and AGI govern no principle.** They remain central to physical combat and can be required by an individual [[Hatsu]], but they never determine whether someone masters a universal principle. **CHA** likewise gates no principle, though abilities built on performance, leadership, deception, or emotional bonds may lean on it.

The five Advanced principles deliberately have five *different* Primaries — DEX, WIS, INT, SPI, VIT — so that high-end Nen cannot collapse into a single DEX-and-CON build. Across the fourteen fixed principles the count runs DEX 9 · CON 6 · INT 4 · PER 4 · WIS 3 · VIT 3 · SPI 1, which measures how often a stat appears, not how much it is worth: SPI appears once and modifies every Breakthrough Check in the game.
...
- **Primary job — containment.** Ten sets how much of your aura *stays where you put it* instead of leaking away. This is the **containment %** in every concentration calculation ([[Aura Density and Concentration]]): II 80% · IV 88% · VI 94% · VIII 98% · X 100%. A low-Ten fighter who concentrates via [[Gyō]] or [[Kō]] loses a fifth of the aura they move; a Ten X master loses none. **Ten is why concentration works at all** — without it, aura poured into a fist just boils back off.
- **Shroud.** Also grants a standing defense: **Guard = 1% of max AP** (min 1), refreshing at the start of your turn; whole-body Soak = Guard ÷ 10 (the density math, [[Aura Density and Concentration]]). Grants +rank to Composure (CHA) saves against bloodlust and emotional Nen. From rank VI, visibly slows aging ([[Ten]]).
- **Ranks:** II — must hold consciously; Concentration (CON) checks when damaged; drops in sleep; containment 80%. IV — automatic while awake, upkeep-free; containment 88%. VI — shroud 1.5% AP; holds itself under pain; containment 94%. VIII — persists asleep or unconscious; shroud 2%; containment 98%. X — shroud 2.5%; cannot be stripped short of 0 AP; **containment 100%** (nothing you concentrate ever leaks).
...
- **Prereq:** Ten II.
- **Action:** 1 action to enter or exit (rank VIII: reaction). **Cost:** none.
...
- **Senses sharpen** (whole-body): +2 to Aura Sense (PER), and at rank VI+ you may contest [[In]] with **PER + Zetsu rank** (the lore's "Zetsu can counter In, though not advised").
...
- **Ranks:** II — stationary or slow movement only; any aura use breaks it. IV — hold while acting mundanely. VI — the counter-In sense; hold under stress. VIII — enter as a reaction. X — even gaze-detection is DC 36; you read as *absent*.
...
- **Prereq:** Ten II.
- **Action:** 1 action to flare (minor at rank VI+). **Cost:** free to hold in combat; out of combat, sustained Ren costs 1% AP/minute.
- **Primary job — output.** Ren sets how much of your pool you can **project this round**: **Output % = 2 × Ren rank** (4% at II … 20% at X; [[Aura Statistics]]) — the one principle whose scale is continuous rather than stepped. **Ren governs output, never pool** — a huge-CON reservoir does nothing for you in a given round beyond what your Ren can pipe out of it. While Ren is up you are *visibly* alight to any Nen user (unless [[In]]).
- **Duration cap** (out-of-combat sustained): II — 2 min · IV — 10 min · VI — 30 min · VIII — 2 h · X — all day. (Lore: a month of training per +10 minutes, [[Ren]].)
...
- **Prereq:** Ren II.
- Not an action; a capacity. Hatsu rank gates what your aura can *become*: the Effect Budget of designed abilities ([[Hatsu Design]]), Water Divination potency, and advanced principles that list it. Trained via category exercises and [[Water Divination]] drills ([[Hatsu Training]]).
- **Ranks:** II — divination-grade expression; may seed a first ability. IV — first full ability form; unlocks advanced principles listing Hatsu IV. VI — second form / second ability; VIII — mature signature ability; X — your Nen answers you like a limb.
...
- **Prereq:** Zetsu IV, Ren IV.
- **Action:** woven into whatever it hides. **Cost:** +25% of the concealed effect's aura cost (min 5/round).
- **Effect:** Hide an active aura effect — your Ren state, a Strike wind-up, a conjured object, a trap, an emitted construct. Detection requires eyes-Gyō (or Zetsu VI sense, or [[En]] contact) *and* winning the opposed check: **DEX + In rank vs PER + Gyō rank** (concealment is precise aura-control — DEX; detection is noticing — PER).
- **Ranks** raise what can be hidden: II — one small static effect · IV — your own combat aura (hide your per-region [[Aura Density and Concentration|distribution]]!) · VI — moving constructs/projectiles · VIII — multi-part ability assemblies · X — near-total (even En must win the contest to feel it).
...
- **Radius by rank:** II — 2 m · IV — 5 m · VI — 10 m · VIII — 25 m · X — 50 m. (Beyond 50 m is ability territory: [[Hatsu Design]].)
...
- **Ranks:** II — one handheld object · IV — object persists 1 round after leaving your hand (a thrown wrench that still bites) · VI — flexible/segmented (chains, whips, cloth) and fired ammunition (full flight) · VIII — two objects or one large (a door, a beam) · X — worn armor as second skin, fine tools (a Shū lockpick with feedback).
...
- **Effect:** whole-body, even coverage — Guard from Ken cannot be "read thin" (immune to the Ryū read-game below). Guard value multiplier: ×1 (I–II), ×1.25 (III–IV), ×1.5 (V). At rank VIII you may hold a 2 m tactile mini-[[En]] while in Ken.
...
- **Caps by rank** (final bonus): II — +2 · IV — +4 · VI — +6 *or* +1 [[Scale Speed and Magnitude|SR]] · VIII — +8 and +1 SR · X — +10 and +2 SR.
- **Risks:** sustaining Chū beyond CON mod minutes: 1 Strain/minute. Exceeding the rank cap via desperation ([[Rulebook/05 Progression/Progression and Training]], Overreach) injures.
...
- **Prereq:** Ten IV, Zetsu IV, Ren VI, Gyō IV (Shū IV if on a weapon), Chū IV.
...
- **Ranks:** II — offensive only, set at turn start · IV — defensive use · VI — set as part of an attack (no tell until the swing) · VIII — hold Kō through a missed strike · X — Kō twice in a round, each fully computed.
...
- **Prereq:** Gyō VI, Ken IV, Chū IV (Shū optional).
- **Action:** the upgrade is that allocation stops being turn-locked: you may **reallocate as a reaction** (once per round at rank II, twice at III, unlimited at V).
...
- **Ranks** also govern shaping: VI — anchor the boundary to terrain; VIII — asymmetric boundaries (dome, corridor); X — persistent boundary sustained at half upkeep.
...
- **Prereq:** Ren VI, Hatsu IV, Gyō VI, Chū VI, **Control 4+**.
- **Action:** full concentration, every round; no other Nen use of any kind while channeling ([[Yū]]: "completely vulnerable"). **This is the most aura-hungry principle in the game** ([[Yū]] lore), tuned so it cannot be combat spam:
...
- **Ranks:** II — surface only · IV — internal · VI — regeneration · VIII — treat *others* (double cost) · X — halve all conversion costs.
...
## Instinctive principle use

Animals, [[Monsters]], and low [[Hollow]]s can hold instinct-grade Principles (Zetsu especially, [[Nen and Nature]]) and rarely one intermediate principle, always rank II–IV equivalent, never [[Hatsu]] and never advanced principles. Stat them with the principle listed and no rank progression — instinct doesn't train.
