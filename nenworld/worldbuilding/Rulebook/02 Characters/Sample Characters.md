...
**What the three show together:** identical creation budgets diverge into scout/wall/eyes *before* Nen; **CON placement (13/15/12)** sets three different starting pools — and, because pool is derived from CON, three different *growth spines* (raise CON, raise the pool), which is why the Orckin tank ends year two with the deepest reserves; **DEX (14/8/14)** decides who executes precise Nen and who swings blunt force; **SPI (11/10/12)** sets whose manifestations land first try. Each ability grew from the sheet's ties and flaws — the [[Hatsu Design]] Seed test passing in the wild. At year two all three sit in the professional band together despite different pools (805/1.3k/503) and CON (17/18/16): bands are wide, parties hold together ([[Balance and Math]]).
