...
At creation (see [[Character Creation]]): **Standard array** — 15, 14, 13, 12, 11, 10, 10, 9, 8, 8 assigned freely — or **point buy**: all scores start at 8; 24 points; 1 point per step to 13, 2 per step to 16 (16 max at creation before race). Racial adjustments then apply. **SPI cannot be raised above 16 at creation by any human**, and players should be told SPI's description ("innate Nen talent") without its mechanics — where they place it is already a story bet on being the one who lands the impossible.

Because CON now sets the aura ceiling and VIT sets recovery, a player's array *is* their eventual Nen build in embryo — but none of it matters until awakening, and the fodder phase rewards the physical and social stats first ([[Character Creation]]).
...
| Skill | Attr | Covers |
|---|---|---|
| Athletics | STR | Climbing, swimming, jumping, forcing |
| Grappling | STR | Holds, throws, pins ([[Combat Core]]) |
| Acrobatics | AGI | Tumbling, balance, squeezing, falling |
| Stealth | AGI | Moving unseen/unheard (aura concealment is separate: [[In]]/[[Zetsu]]) |
| Sleight of Hand | DEX | Picking, palming, planting, tying |
| Craft | DEX | Making and repairing (pick a field) |
| Endurance | CON | Forced march, holding breath, resisting exhaustion, **Concentration under fire** ([[Combat Core]]) |
| Academics | INT | History, law, geography, sciences |
...
| Aura Sense | PER | Feeling aura: presence, strength, direction ([[Aura Statistics]]; awakened only) |
| Insight | PER | Reading motive, catching lies, reading a fight in the moment |
| Persuasion | CHA | Honest social force |
| Deception | CHA | Dishonest social force |
| Intimidation | CHA | Fear as a tool (raw bloodlust is [[Ren]], not a skill) |
| Performance | CHA | Art, disguise-as-craft, crowds |
| Streetwise | CHA | Underworld navigation, contacts, rumor |
| Composure | CHA | Resisting fear, provocation, pain, interrogation, mundane intimidation |
...
A save is an attribute check the GM calls for:
