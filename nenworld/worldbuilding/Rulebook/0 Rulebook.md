...
4. [[Aura Statistics]] → [[Aura Density and Concentration]] — the seven aura quantities (pool from CON, regen from VIT, output from Ren) and the surface-area density engine under Gyō/Kō/Chū. **Read the density chapter before the principles.**
