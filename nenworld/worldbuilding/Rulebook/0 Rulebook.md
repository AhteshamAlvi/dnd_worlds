...
1. **Everyone starts as fodder.** Player characters begin with no Nen, no abilities, and no fruit powers — ordinary people of their race, with skills and gear justified by backstory. Awakening, the [[0 Four Major Principles|Four Major Principles]], divination, and a first [[Hatsu]] are *play*, not character creation. Target pace: a functioning Nen user by the end of the first arc (roughly 4–8 sessions).
...
5. **Growth is grown, not granted.** Progression runs on **three tracks that never convert into one another** ([[Rulebook/05 Progression/Progression and Training|Progression and Training]]): Character Level (XP, 1–30), attributes (Stat Points, each capped at 30), and per-principle Nen mastery (Growth Points, I–X). Levels exist but measure *experience*, not power — two level-20 characters can share nothing. XP comes from meaningful development, never from kills: a fight pays when it pressures, surprises, or teaches, and losing can pay full value. Every spend still needs an in-fiction justification — training time, a teacher, a Catalyst, or the Do → Notice → Propose → Justify loop from [[Developing a Nen Ability]] — and the top three mastery ranks additionally demand a **Breakthrough** roll that destroys the investment on a failure. Aura quantity itself is never bought; it derives from CON and VIT.
6. **Model first; automation executes.** Nenworld is built to be played through a FoundryVTT module that resolves the math, so **computational depth is never traded away for hand-arithmetic convenience.** Where a more accurate, more consistent, more simulation-true mechanic exists — surface-area [[Aura Density and Concentration|aura density]], VIT-scaled regeneration, log-curve [[Nen Principles (Rules)|Chū]] — this book uses it, and provides a lookup table or rounded shortcut for bare-table play rather than dumbing the mechanic down. Deep at build/level/GM-prep time; simple in the moment because the tool (or a table) carries the load.
...
The lore pages in [[0 Nen|Nen]], [[0 Races|Race]], and [[0 Power System|Power System]] are canon and are **never overridden** by this book. Where this book quantifies something the lore left qualitative (how much aura a novice has, what [[Ken]]'s "10 times" means in play, what a [[Vows and Limitations|Vow]] is worth), the rule is a **system-design addition** and the chapter says so, with the reasoning. Where the lore gives numbers ([[0 Types of Nen|the 100/80/60/40 affinities]], [[En]]'s 2 m minimum and 50 m mastery, Ken ≈ 10× Ten), the rules reproduce them exactly.
...
4. [[Aura Statistics]] → [[Aura Mathematics]] → [[0 Body|Body]] → [[Aura Density and Concentration]] — the seven aura quantities (pool from CON+VIT, regen from VIT, output from a CON ceiling accessed via Ren), the magnitude math under all three, where a body's regions and their Surface Units actually come from, and the surface-area density engine under Gyō/Kō/Chū. **Read the density chapter before the principles.**
5. [[Awakening and the Path]] → [[Nen Principles (Rules)]] → [[Types and Affinity (Rules)]] → [[Nen Manifestation]] — how PCs become Nen users, what the fifteen principles do, and the one thing SPI does (make new Nen *hold*).
6. [[Conditions Vows and Risk (Rules)]] → [[Hatsu Design]] → [[Hatsu Library]] — the power economy and ability construction.
7. [[Combat Core]] → [[Combat Time]] → [[Injury Recovery and Conditions]] — fighting, allocation, dying, and how real table time converts into the fictional seconds every timed mechanic (aura regen, poison, durations) actually runs on.
8. [[Character Creation]] → [[Sample Characters]] — making the fodder.
9. [[Rulebook/05 Progression/Progression and Training]] — levels, Stat Points, Growth Points, aura growth, training programs.
...
| Awakening | [[Aura Statistics]] (their own numbers only), Ten/Zetsu entries of [[Nen Principles (Rules)]] |
| Learning Gyō/Kō | [[Aura Density and Concentration]] — the surface-area engine, once they concentrate aura for real |
| Training montage | Remaining [[0 Four Major Principles|Four Major Principles]] entries; [[Rulebook/05 Progression/Progression and Training]] player-facing tables |
