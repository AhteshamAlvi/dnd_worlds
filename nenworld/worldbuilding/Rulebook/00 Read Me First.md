...
Every rule in this book follows from five decisions (made with the setting's author). When you have to improvise a ruling, improvise in the direction of these:
...
4. [[Aura Statistics]] — the six aura numbers on every Nen user's sheet, with formulas and worked examples.
5. [[Awakening and the Path]] → [[Nen Techniques (Rules)]] → [[Types and Affinity (Rules)]] — how PCs become Nen users and what the fifteen techniques do mechanically.
...
| First Hatsu attempt | [[Conditions Vows and Risk (Rules)]], [[Hatsu Design]] |
